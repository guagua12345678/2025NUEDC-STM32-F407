...
uint16_t W25QXX_TYPE = 0XEF17;	//默认是W25Q128

//读取芯片ID			   
//0XEF14--W25Q16  0XEF15--W25Q32  0XEF16--W25Q64  0XEF17--W25Q128 	  
...
{ 
	SPI1_NSS(1);	                            //SPI FLASH不选中
	SPI1_Init();		   	                    //初始化SPI
	SPI1_SetSpeed(SPI_BaudRatePrescaler_4);		//设置为24M时钟,高速模式 
